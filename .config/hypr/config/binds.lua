...
hl.bind(mainMod .. " + SHIFT + A", hl.dsp.exec_cmd("gtk-launch webapp-chatgpt-com"))
...
hl.bind("ALT + SPACE", hl.dsp.exec_cmd("foot -T 'pkg installer' ~/.config/hypr/scripts/installer.sh"))
...
hl.bind("ALT + Print", hl.dsp.exec_cmd("~/.config/hypr/scripts/window-screenshot.sh"))
